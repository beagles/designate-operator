...
func (instance *DesignateCentral) GetObservedGeneration() int64 {
	return instance.Status.ObservedGeneration
}

// GetItems - returns the list of DesignateCentral items
func (list *DesignateCentralList) GetItems() []DesignateCentral {
	return list.Items
}
